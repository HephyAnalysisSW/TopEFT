...
from TopEFT.Analysis.regions        import regionsE, noRegions, btagRegions, regions4lB, regionsXSec, noRegionsB, regionsXSecB
...
drawObjects = drawObjects( isData=False, lumi=round(35.9,0)) + drawZero() + drawBinNumbers(6)
