...
for (run, version) in [('B','_v2'),('C',''),('D',''),('E',''),('F',''),('G',''),('H','_v2'),('H','_v3')]:
    ...
    dirs["SingleElectron_Run2016"   + run + version ] = ["SingleElectron_"    + runTag ]#+ "_Trig_e"] # trigger name postfix missing, added for next round
...
allSamples_Data25ns = []
allSamples_Data25ns += [SingleMuon_Run2016, SingleElectron_Run2016]
