...
# extensions
daniel_fwlite_ttZ_ll_LO_sm_ext1                     = FWLiteSample.fromFiles( "ttZ_ll_LO_SM", texName = "SM", files = ["/afs/hephy.at/data/dspitzbart01/TopEFT/samples/ttZ_ll_SM_exp1/events.root"] )
daniel_fwlite_ttZ_ll_LO_DC2A_0p2_DC2V_0p2_ext1      = FWLiteSample.fromFiles( "ttZ_ll_LO_DC2A_0p2_DC2V_0p2", texName = "DC2A_0p2_DC2V_0p2", files = ["/afs/hephy.at/data/dspitzbart01/TopEFT/samples/ttZ_ll_DC2A_0p2_DC2V_0p2_exp1/events.root"] )
