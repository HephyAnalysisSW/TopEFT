...
python cmgPostProcessing.py --deepLepton --skim inclusive --forceProxy --fileBasedSplitting --overwrite --remakeTTVLeptonMVA --year 2016 --processingEra deepLepton_v4 --sample TTJets_SingleLeptonFromTbar #SPLIT100  
python cmgPostProcessing.py --deepLepton --skim inclusive --forceProxy --fileBasedSplitting --overwrite --remakeTTVLeptonMVA --year 2016 --processingEra deepLepton_v4 --sample TTJets_SingleLeptonFromTbar_ext #SPLIT50
python cmgPostProcessing.py --deepLepton --skim inclusive --forceProxy --fileBasedSplitting --overwrite --remakeTTVLeptonMVA --year 2016 --processingEra deepLepton_v4 --sample TTJets_SingleLeptonFromT #SPLIT100
python cmgPostProcessing.py --deepLepton --skim inclusive --forceProxy --fileBasedSplitting --overwrite --remakeTTVLeptonMVA --year 2016 --processingEra deepLepton_v4 --sample TTJets_SingleLeptonFromT_ext #SPLIT50
python cmgPostProcessing.py --deepLepton --skim inclusive --forceProxy --fileBasedSplitting --overwrite --remakeTTVLeptonMVA --year 2016 --processingEra deepLepton_v4 --sample TTJets_DiLepton #SPLIT100
python cmgPostProcessing.py --deepLepton --skim inclusive --forceProxy --fileBasedSplitting --overwrite --remakeTTVLeptonMVA --year 2016 --processingEra deepLepton_v4 --sample TTJets_DiLepton_ext #SPLIT50
