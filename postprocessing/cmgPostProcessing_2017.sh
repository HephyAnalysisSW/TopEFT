...
#python cmgPostProcessing.py --forceProxy --overwrite --skim trilep --fileBasedSplitting  --year 2017 --processingEra TopEFT_PP_2017_mva_v12 --sample TTZToLLNuNu_amc_psw  #SPLIT20
