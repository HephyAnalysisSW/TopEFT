...
#python cmgPostProcessing.py --skim trilep --processingEra TopEFT_PP_v12 --keepLHEWeights --overwrite --sample ewkDM_TTZToLL_LO #SPLIT5
#python cmgPostProcessing.py --skim trilep --processingEra TopEFT_PP_v12 --keepLHEWeights --overwrite --sample ewkDM_TTZToLL_LO_DC2A0p2_DC2V0p2 #SPLIT5
#python cmgPostProcessing.py --skim trilep --processingEra TopEFT_PP_v12 --keepLHEWeights --overwrite --sample ewkDM_TTZToLL_LO_DC1A_0p50_DC1V_m1p00 #SPLIT5
#python cmgPostProcessing.py --skim trilep --processingEra TopEFT_PP_v12 --keepLHEWeights --overwrite --sample ewkDM_TTZToLL_LO_DC1A_0p60_DC1V_m0p24_DC2A0p25 #SPLIT5
#python cmgPostProcessing.py --skim trilep --processingEra TopEFT_PP_v12 --keepLHEWeights --overwrite --sample ewkDM_TTZToLL_LO_DC1A_0p50_DC1V_0p50 #SPLIT5
#python cmgPostProcessing.py --skim trilep --processingEra TopEFT_PP_v12 --keepLHEWeights --overwrite --sample ewkDM_TTZToLL_LO_DC1A_1p00_DC1V_0p00 #SPLIT5
