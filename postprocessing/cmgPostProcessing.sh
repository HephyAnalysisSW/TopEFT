...
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample TTZToLLNuNu_ext  --overwrite # SPLIT20
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample WZTo3LNu_amcatnlo  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample TTWToLNu_ext TTWToLNu_ext2  --overwrite # SPLIT20
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample TTHnobb_pow  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample tWll  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample tZq_ll_ext  --overwrite # SPLIT20
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample ZZTo4L  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample WZZ  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample WWZ  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample ZZZ  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample ZGTo2LG_ext  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample WGToLNuG  --overwrite # SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample TTGJets TTGJets_ext  --overwrite # SPLIT20
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample TTTT  --overwrite # SPLIT10
#
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample TTLep_pow --overwrite #SPLIT30
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample GGHZZ4L #SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample TGJets TGJets_ext #SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample TTZToLLNuNu_m1to10 #SPLIT2
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample VHToNonbb #SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample WWDoubleTo2L #SPLIT10
#python cmgPostProcessing.py --skim trilep --keepAllJets --keepLHEWeights --processingEra TopEFT_PP_v12 --sample WpWpJJ #SPLIT10
