...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring(['file:TOP-RunIIFall17DRPremix-00189.root',]),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TOP-RunIIFall17MiniAOD-00189.root'),
